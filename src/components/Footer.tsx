...
const Footer = () => {
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
      <span className="ml-3 text-xl text-black">BioHacks</span>
    </a>
    <p className="text-sm text-black sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2024 —
      <a href="http://kuki.co.in" className="text-gray-900 ml-1" target="_blank" rel="noopener noreferrer">Bioheritage.co</a>
    </p>
